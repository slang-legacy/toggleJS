...
(function() {
  ...
  (function($) {
    var OFF, ON, counter, defaults, toggle;
    $.toggleSwitch = {
      version: "1.0.03",
        ...
        if (method.toLowerCase() === "object") {
          ...
          this.each(function(i) {
            ...
            if (i === 0 && r) {
              ...
              if (!!r && !!r.jquery) return result = result.add(r);
            }
          });
          return result || this;
        } else {
